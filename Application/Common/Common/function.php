 ...
 *
 */
function sendForm($url, $data, $referer = "localhost")
{
 ...
 * @return bool|string
 */
function curlPostContent($durl, $post_data, $headers = array())
{
    //初始化
    $curl = curl_init();
    //设置抓取的url
 ...
 * @return bool|string
 */
function curlGetContent($durl, $headers = array())
{
    // 初始化
    $curl = curl_init();
    // 设置url路径
